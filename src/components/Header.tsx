    ...
    <header className="header-wrapper">
      <div className="header-container">
        ...
        <div className="header-left">
          ...
          >
            <img src={HamburgerIcon} alt="Menu" width="30" height="30" />
          </button>
        </div>
        ...
        <div className="header-right">
          ...
          <div className="user-badge-container" ref={languageDropdownRef}>
            <button
              className="user-badge"
              onClick={() => setUserDropdownOpen(!languageDropdownOpen)}
              aria-haspopup="true"
              aria-expanded={languageDropdownOpen}
            >
              <div className="user-avatar">VN</div>
              <span className="user-name">Vietnamese</span>
              <svg
                width="16"
                height="16"
                viewBox="0 0 14 14"
                fill="none"
                className={`user-chevron ${languageDropdownOpen ? "open" : ""}`}
              >
                <path
                  d="M3 5L7 9L11 5"
                  stroke="currentColor"
